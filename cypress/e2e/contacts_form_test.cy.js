describe('Тестування форми "Контакти"', () => {
  ...
  const generateRandomData = () => {
    ...
    const messages = [
      'Не реагуйте на цей лист!!! Це тестове повідомлення для перевірки форми контактів.',
      'Тестове повідомлення для автоматизованого тестування форми.',
      'Це автоматичний тест форми контактів, будь ласка, ігноруйте.',
      'Перевірка функціональності форми контактів.',
    ];
