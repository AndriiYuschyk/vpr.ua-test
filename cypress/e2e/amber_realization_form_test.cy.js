describe('Тестування форми "ЗАЯВКА" - Реалізація бурштину', () => {
    ...
    const generateRandomData = () => {
        const names = ['ТОВ "Тест-Бурштин-Плюс"', 'ПП "Тест-Янтар-Трейд"', 'ООО "Тест-Амбер-Експорт"', 'ТОВ "Тест Золотий Камінь"'];
        const edrpouCodes = ['12345678', '87654321', '11223344', '99887766'];
        const fullNames = ['Іваненко Іван Іванович', 'Петренко Петро Петрович', 'Сидоренко Сидір Сидорович', 'Коваленко Олександр Михайлович'];
        ...
        return {
            ...
            message: 'Не реагуйте на цей лист!!! Це тестове повідомлення призначається лише для перевірки роботи відправки форми!!!'
        };
    };
    ...
    describe('Позитивні тести', () => {
        it('Успішне заповнення всіх полів форми з валідними даними', () => {
            ...
            // Покращені перевірки для select-ів з візуальною верифікацією
    ...
    describe('Негативні тести', () => {
        it('Відправка форми з порожніми обов\'язковими полями', () => {
            ...
            cy.get('.messages--error, .error, .form-item--error-message')
                .should('exist');
        });
        ...
        it('Некоректний формат email', () => {
            ...
            invalidEmails.forEach(email => {
                ...
                cy.get('.messages--error, .error, [data-drupal-selector="edit-email"] + .form-item--error-message')
                    .should('exist');
            });
        });
    ...
    describe('Тест відправки форми (ПРОДУКЦІЯ)', () => {
        it('Успішна відправка валідної форми', () => {
            ...
            cy.get('.messages--status, .messages-status')
                .should('be.visible')
                .and('contain.text', 'відправлено'); // Адаптуйте під ваше повідомлення

            // Альтернативно - перевірка редиректу
